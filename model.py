...
class MutationBert(FairseqEncoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--msa-length", type=int, default=1273,
...
class MutationBertEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary):
        ...
        self.fit_embeds = nn.Embedding(2, args.encoder_embed_dim) 
        print(args)  # [2, dim]
        
        self.msa_mapping_feature = nn.Linear(300 + 1, self.vocab_size)
        #self.single_msa_features = get_msa_features(args.remote_msa_path, args.single_msa_file)  # [L, 21]
       # self.pair_msa_features = get_msa_features(args.remote_msa_path, args.pair_msa_file) 
        self.single_msa_features = get_msa_features()  # [L, 21]
        self.pair_msa_features = get_msa_features()     # [L, L, 21*21]
        #self.lambda_prediction = args.lambda_prediction
        self.lambda_prediction = 0.8
        print(args)
